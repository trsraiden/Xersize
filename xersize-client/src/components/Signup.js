        ...
        <Container className='d-flex' style={{maxWidth:'500px'}}>
            <div className='w-100'>
              ...
              <Form onSubmit={handleSubmit}>
                  ...
                  <button disabled={loading} className='startButton w-100' type='submit'>Sign Up</button>
              </Form>
          </div>
        </Container>
        <div className='w-100 text-center mt-2'>
            <p>Already have an account? <button disabled={loading} onClick={handleLogin} className='generalButton'>Login</button></p>
        </div> 
